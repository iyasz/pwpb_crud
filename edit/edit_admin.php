...
if (isset($_POST['submit'])) {
    ...
    $update = $conn->query("UPDATE admin SET nama = '$nama', username = '$username', password = '$password', telepon = '$telepon', email = '$email' WHERE id = '$id'");
    if ($update == TRUE) {
            ...
            <div class="col-md-12">
                <div class="card shadow-lg mb-3">
                    <div class="card-header bg-dark mb-3">
                        <h3 class="mb-0 text-white ps-5">Update Data Admin</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" value="<?= $datas['username'] ?>" autocomplete=" off" name="username" id="kontak" placeholder="Nama Kontak" required class="form-control mb-3 aa">
                                    </div>
                                    <div class="form-group mt-3">
                                        <label for="">Password <i class='bx bx-phone'></i></label>
                                        <input type="text" value="<?= $datas['password'] ?>" name=" password" required autocomplete="off" id="kontak" placeholder="Nomor Telepon" class="form-control mb-3 aa">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <label for="">Telepon <i class='bx bx-home-alt-2'></i></label>
                                        <input type="number" required name="telepon" id="kontak" placeholder="Masukan Alamat" autocomplete="off" value="<?= $datas['telepon'] ?>" class=" form-control mb-3 aa">
                                    </div>
                                    <div class="form-group mt-3">
